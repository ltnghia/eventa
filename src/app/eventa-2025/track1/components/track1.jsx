...
const Track1 = () => {
    return (
        <div className="text-justify">
           ...
           <code className="text-blue-600 font-semibold">Given an image, participants are required to search relevant articles in a provided external database and extract necessary information to enrich the image caption.</code> 
