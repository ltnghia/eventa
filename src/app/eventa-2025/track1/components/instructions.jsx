const Instruction = () => {
    return (
        <div className="text-justify">
            <p>
                Participants require to submit a CSV file with the format name (<span className="font-bold">TeamName_EVENTA2025_Track1.csv</span>) to <span className="font-bold"><a  target="_blank" href='https://codalab.lisn.upsaclay.fr/competitions/' className="underline text-[1.1em] text-[#232ba1]">CodaLab</a></span>. The file has to be compressed to <span className="font-bold">submission.zip</span> before being submitted to CodaLab.
            </p>
            <br/>
            <p>
