const ImportantDates = () => {
    return <div className="text-justify">
        ...
        <ul className="list-disc list-inside space-y-2 mt-2 ml-4">
            ...
            <li>Training set released: <span className="font-bold"> Apr. 17, 2025 </span></li>
            <li>Public-test set released: <span className="font-bold"> May. 01, 2025 </span></li>
            <li>Team registration deadline: <span className="font-bold"> Jun. 9, 2025 </span></li>
