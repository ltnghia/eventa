const CallForPapers = () => {
    return (
        <div className="text-justify">
            ...
            <br/>
            <span className="font-bold text-[1.3em]"><a href='https://cmt3.research.microsoft.com/EVENTA2025' className="underline text-[1.1em] text-[#232ba1]">Submit your paper here</a></span>.
        </div>
    )
}
