  ...
  return (
    <div className="text-justify">
      ...
      <ul className="list-disc ml-6 space-y-1">
        <li><strong>09:00 – 09:10</strong> - <strong>Prof. Minh-Triet Tran:</strong> Opening Remarks</li>
        ...
        <li><strong>10:25</strong> - <strong>Prof. Minh-Triet Tran:</strong> Closing Remarks</li>
      </ul>
    </div>
  );
};
