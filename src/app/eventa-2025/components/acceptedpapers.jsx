const AcceptedPapers = () => {
    return (
        <div className="text-justify">
            <td className="px-3 py-2 font-bold">ACM Multimedia 2025 Proceedings:</td>
            <ol className="list-disc list-inside space-y-2 mt-2 mb-8 ml-4">
                <li>Cerebro Team, &quot;ENRIC: EveNt-AwaRe Captioning with Image Retrieval via UnCertainty-Guided Re-ranking and Semantic Ensemble Reasoning&quot;. [<a href="https://dl.acm.org/doi/10.1145/3746027.3762090" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PDF</a>] </li>
                <li>SodaBread Team, &quot;ReCap: Event-Aware Image Captioning with Article Retrieval and Semantic Gaussian Normalization&quot;. [<a href="https://dl.acm.org/doi/10.1145/3746027.3762039" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PDF</a>] </li>
                <li>NoResources Team, &quot;EVENT-Retriever: Event-Aware Multimodal Image Retrieval for Realistic Captions&quot;. [<a href="https://dl.acm.org/doi/10.1145/3746027.3762038" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PDF</a>] </li>
            </ol>
            <td className="px-3 py-2 font-bold">Unachieved Papers:</td>
            <ol className="list-disc list-inside space-y-2 mt-2 mb-8 ml-4">
                ...
                <li>Sharingan Retrievers Team, &quot;Leveraging Lightweight Entity Extraction for Scalable Event-Based Image Retrieval&quot;. [<a href="https://drive.google.com/file/d/1cXW2PCxcR1JnqCtsvv0cDAWGuMkiBPOV/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">PDF</a>] </li>
